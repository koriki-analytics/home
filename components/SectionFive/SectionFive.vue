  ...
  <section class='mt-[55px] lg:mt-[144px] flex justify-center font-hubot trigger'>
    <div class="max-w-[1550px]">
      ...
      <div class="flex flex-col lg:flex-row lg:gap-7 gap-[50px] items-center px-4 ">
        ...
        <div class="bg-tetiary max-w-360px w-fit rounded-b-[28px] z-2 lg:z-4 scroll-up">
      ...
      <div class="flex gap-9 lg:gap-25 justify-center w-full items-center mix-blend-darken bounce ">
        <img class="size-[80px] md:size-[120px] lg:size-auto " src="../../assets/Youtube.svg">
        <img class="size-[31px] md:size-[50px] lg:size-auto" src="../../assets/X.svg">
        <img class="size-[31px] md:size-[50px]  lg:size-auto" src="../../assets/instagram.svg">
        <img class="size-[31px] md:size-[50px]  lg:size-auto" src="../../assets/facebook.svg">
        <img class="size-[31px] md:size-[50px]  lg:size-auto" src="../../assets/tiktok.svg">
      </div>
    </div>
  </section>
</template>
